  ...
  return (
    <footer className="w-full bg-black overflow-hidden relative">
      ...
      <div className="relative w-full bg-gradient-to-b from-woodsmoke-950 via-woodsmoke-950/90 via-25% to-transparent to-100% z-20 py-4 px-6 lg:px-2">
        <div className="max-w-screen-xlg mx-auto grid grid-cols-1 sm:grid-cols-4 md:grid-cols-6 gap-[50px] md:gap-[67px] pt-[88px] px-6 lg:px-2 pb-12">
        ...
        <div className="max-w-screen-xlg mx-auto mt-8 md:mt-12 flex flex-col sm:flex-row justify-between items-center px-6 lg:px-2 pb-8">
